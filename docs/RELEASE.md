...
## v0.2.0 (2026-02-06) - Enhanced Tools Tab

### New Features

**JSON Formatter:**
- Tree view with expand/collapse functionality (like json.cn)
- Syntax highlighting for different value types
- Preview mode showing item counts
...
- Quick toggle between Escape/Unescape modes
- Enhanced swap functionality
- Support for more escape sequences (\\b, \\f, \\v)
